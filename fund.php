...
<form class="form-inline" align='center' method='POST' action='fund1.php'>
<div class="form-group">
  <br><br>
<label color="orange">Enter Account Number of recipient: &nbsp&nbsp</label>
<input style='width:200px' class="form-control" style='text-align:center' name='acno' placeholder='Account Number' type='text'>
<br><br>
<label color="orange">Enter Funds to transfer to recipient: &nbsp&nbsp</label>
<input style='width:200px' class="form-control" style='text-align:center' name='funds' placeholder='Funds' type='text'>
<br><br>
