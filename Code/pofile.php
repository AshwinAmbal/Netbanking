...
<body style="width=1080px; margin=0 auto;background:url(1619726.jpg);no repeat center scroll" oncontextmenu="return false">
<div id="navbar-main">
      <!--Fixed navbar -->
...
<div class="alert alert-warning alert-dismissible" role="alert" style="text-align:center;">
  ...
  <h5 style="text-align:right;"><b><?php date_default_timezone_set('Asia/Kolkata');echo date('d-m-Y h:i:s a');?> GMT+0530(Indian Standard Time)&nbsp&nbsp</b></h5><br><br><br><br><br><br><br>
<form class="form-inline" align="center" method="POST" action="profile.php">
  <div class="form-group">
    <label for="exampleInputPassword1"><font color="orange">Enter Profile Password:</label></font>
    <input type="password" class="form-control" id="exampleInputPassword3" placeholder="Profile Password" name="PPassword">
  </div>
  <br>
  <br>
  ...
  <a href='mainpage.php' class="btn btn-danger">Cancel</button></a>
</form>
