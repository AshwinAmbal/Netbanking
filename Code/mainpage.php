...
<body style="width=720px; margin=0 auto;background-image:url('modern-background-design.jpg');no repeat center scroll">
<div id="navbar-main">
      <!--Fixed navbar -->
    ...
    while($AC=mysql_fetch_array($res))
        {
          ...
          echo "<td><a href='mainpage1.php'>Click here for balance</a></td>";
